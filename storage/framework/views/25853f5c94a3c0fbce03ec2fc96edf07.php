...
<div class="dashboard__main">
      <div class="dashboard__content">
        ...
        <div class="row y-gap-20 justify-between items-end pb-20 lg:pb-40 md:pb-32">
          ...
          <div class="col-auto">
          <a href="<?php echo e(URL::to('/admin/create_user')); ?>" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Skypass_Travel-main\resources\views/admin/Users/index.blade.php ENDPATH**/ ?>