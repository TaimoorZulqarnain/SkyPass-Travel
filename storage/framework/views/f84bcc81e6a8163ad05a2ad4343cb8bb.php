...
<div class="dashboard__main">
      <div class="dashboard__content">
        <div class="row y-gap-20 justify-between items-end pb-20 lg:pb-40 md:pb-32">
          ...
          <div class="col-auto">
            <a href="<?php echo e(URL::to('/admin/create_departure')); ?>" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">
                      ...
                      <td><?php echo e($loop->iteration); ?></td>
                        ...
                        <td>
                          <div class="row x-gap-10 y-gap-10 items-center">
                              <a href="<?php echo e(route('departure.edit',$departure->id)); ?>" class="flex-center bg-light-2 rounded-4 size-35">
                                <i class="icon-edit text-16 text-light-1"></i>
                              </a>
                              <a href="<?php echo e(route('departure.delete', ['id' => $departure->id])); ?>" class="flex-center bg-light-2 rounded-4 size-35" onclick="confirmation(event)">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Skypass_Travel-main\resources\views/admin/Departure/index.blade.php ENDPATH**/ ?>