    ...
    <div data-anim="fade" class="header__container px-30 sm:px-20">
      <div class="-left-side">
        <a href="#!" class="header-logo" data-x="header-logo" data-x-toggle="is-logo-dark">
          ...
          <img src="<?php echo e(asset('/assets/img/logo_black.png')); ?>" alt="logo icon">
          <img src="<?php echo e(asset('/assets/img/logo_black.png')); ?>" alt="logo icon">
        </a>
      </div>
...
<!-- 
                        ...
                        >
                          <div class="notification-list_content">
                            <div class="notification-list_img">
                              <img src="<?php echo e(asset('/admin-assets/img/avatars/add-2.png')); ?>" alt="user" />
            ...
            <div class="pl-15">
              ...
              <img src="<?php echo e(asset('/admin-assets/img/avatars/3.png')); ?>" alt="image" class="size-50 rounded-100 object-cover">
            </div>
          </div>
        </div>
      </div>
    </div>
  </header><?php /**PATH C:\xampp\htdocs\Skypass_Travel-main\resources\views/admin/partials/navigation.blade.php ENDPATH**/ ?>