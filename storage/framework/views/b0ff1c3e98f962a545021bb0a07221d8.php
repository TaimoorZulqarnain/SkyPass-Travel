...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/font-awesome/6.3.0/css/all.min.css')); ?>" crossorigin="anonymous" referrerpolicy="no-referrer" />
  <!-- Stylesheets -->
  <link rel="stylesheet" href="<?php echo e(asset('/assets/css/bootstrap.min.css')); ?>">
  <link href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap5.min.css" rel="stylesheet">
  <link rel="stylesheet" href="<?php echo e(asset('/admin-assets/css/vendors.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('/admin-assets/css/main.css')); ?>" rel="stylesheet"/>
  ...
  <script src=" <?php echo e(asset('/admin-assets/js/vendors.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\Skypass_Travel-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>