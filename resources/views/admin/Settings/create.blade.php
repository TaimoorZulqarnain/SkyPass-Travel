          ...
          <div class="py-15 px-30 rounded-4 bg-white custom_shadow">
            <div class="tabs -underline-2 js-tabs">
              <div class="tabs__content pt-30 js-tabs-content">
                <form class="needs-validation" novalidate action="{{ route('airline.store') }}" method="post" enctype="multipart/form-data">
                  @csrf
                      ...
                      <div class="row x-gap-20 y-gap-20">
                        <div class="col-xl-6 col-md-6 col-sm-12">
                          <div class="form-input ">
                            ...
                            <input type="text" name="name" required class="form-control @error('title', 'post') is-invalid @enderror" id="name" placeholder="Enter Airline Name" value="{{old('name')}}">
                            <div class="invalid-feedback">Please Enter Airline-Title field.</div>
                            @if ($errors->has('name'))
                              ...
                              <label for="imageUpload">
                                <div class="d-flex ratio ratio-1:1">
                                  <div class="flex-center flex-column text-center bg-blue-2 h-full w-1/1 absolute rounded-4 border-type-1">
                                    ...
                                    <input class="form-control" type="file" id="imageUpload" name="image" accept="image/png, image/jpeg" style="display: none;" required>
                                    <div class="invalid-feedback">Please Enter Airline-Image.</div>
