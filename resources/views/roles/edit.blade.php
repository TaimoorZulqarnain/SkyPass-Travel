    ...
    <div class="dashboard__main">
        <div class="dashboard__content">
            <div class="row y-gap-20 justify-between items-end pb-20 lg:pb-40 md:pb-32">
                <div class="col-auto">
                    <h1 class="text-30 lh-14 fw-600">Edit Roles</h1>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-md-6 col-lg-4">
                                                <div class="custom-control custom-checkbox custom-control-primary">
                                                    {{ Form::checkbox('permissions[]',  $permission->id, $role->permissions->contains('id', $permission->id), array('class'=>'custom-control-input', 'id'=>$permission->name)) }}
