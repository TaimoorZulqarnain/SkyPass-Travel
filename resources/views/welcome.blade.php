      ...
      <div class="row align-items-center">
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <img src="{{asset('assets/img/banner/banner-5.jpg')}}" alt="Slide 1">
                </div>
                <div class="carousel-item">
                  <img src="{{asset('assets/img/banner/banner-5.png')}}" alt="Slide 2">
                </div>
        ...
        <div class="col-lg-4">
          <div class="banner_four_img">
            <img src="{{asset('assets/img/banner/banner-5.png')}}" alt="img" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
            ...
            <div class="about_two_left_middel">
              <div class="about_two_item">
                <div class="about_two_item_icon">
                  <img src="{{asset('assets/img/icon/about-1.png')}}" alt="icon">
                </div>
              ...
              <div class="about_two_item">
                <div class="about_two_item_icon">
                  <img src="{{asset('assets/img/icon/about-2.png')}}" alt="icon">
                </div>
                <div class="about_two_item_text">
              ...
              <div class="about_two_item">
                <div class="about_two_item_icon">
                  <img src="{{asset('assets/img/icon/about-3.png')}}" alt="icon">
                </div>
                <div class="about_two_item_text">
        ...
        <div class="col-lg-7 col-md-12 col-sm-12 col-12">
          <div class="about_two_left_img">
            <img src="{{asset('assets/img/common/about_two.png')}}" alt="img">
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12">
          <div class="tour_type_slider button_style_top_left owl-theme owl-carousel">
            <div class="tour_type_boxed">
              <img src="{{asset('assets/img/icon/forest.png')}}" alt="icon" />
              <h3>Explore Forest</h3>
              <p>Package starts from $120</p>
            </div>
            <div class="tour_type_boxed">
              <img src="{{asset('assets/img/icon/bag1.png')}}" alt="icon" />
              <h3>Lone Travel</h3>
              <p>Package starts from $300</p>
            </div>
            <div class="tour_type_boxed">
              <img src="{{asset('assets/img/icon/tour.png')}}" alt="icon" />
              <h3>Adventure Tour</h3>
              <p>Package starts from $415</p>
            </div>
            <div class="tour_type_boxed">
              <img src="{{asset('assets/img/icon/family.png')}}" alt="icon" />
              <h3>Family Tour</h3>
              <p>Package starts from $220</p>
            </div>
            <div class="tour_type_boxed">
              <img src="{{asset('assets/img/icon/beach.png')}}" alt="icon" />
              <h3>Beach Tour</h3>
              <p>Package starts from $220</p>
            </div>
            <div class="tour_type_boxed">
              <img src="{{asset('assets/img/icon/bag.png')}}" alt="icon" />
              <h3>Lone Travel</h3>
              <p>Package starts from $300</p>
            </div>
            <div class="tour_type_boxed">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="top_details_four_item">
            <img src="{{asset('assets/img/banner/banner-5.png')}}" alt="" />
        ...
        <div class="col-lg-9">
          <div class="top_details_four_slider button_style_top_left owl-theme owl-carousel">
            <div class="common_card_four">
              <div class="common_card_four_img">
                <a href="tour-search.html">
                  <img src="{{asset('assets/img/tour/popular-1.png')}}" alt="img" />
                </a>
              </div>
            ...
            <div class="common_card_four">
              <div class="common_card_four_img">
                <a href="tour-search.html">
                  <img src="{{asset('assets/img/tour/popular-2.png')}}" alt="img" />
                </a>
              </div>
              <div class="common_card_four_text">
                <ul class="common_card_four_list">
            ...
            <div class="common_card_four">
              <div class="common_card_four_img">
                <a href="tour-search.html">
                  <img src="{{asset('assets/img/tour/popular-3.png')}}" alt="img" />
                </a>
              </div>
              <div class="common_card_four_text">
                <ul class="common_card_four_list">
            ...
            <div class="common_card_four">
              <div class="common_card_four_img">
                <a href="tour-search.html">
                  <img src="{{asset('assets/img/tour/popular-4.png')}}" alt="img" />
                </a>
              </div>
              <div class="common_card_four_text">
                <ul class="common_card_four_list">
              ...
              <div class="row">
                  ...
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel1.png')}}" alt="img" />
                      </a>
                      <p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel2.png')}}" alt="img" />
                      </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel3.png')}}" alt="img" />
                      </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel4.png')}}" alt="img" />
                      </a>
                      <p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel5.png')}}" alt="img" />
                      </a>
                      <p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel6.png')}}" alt="img" />
                      </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel7.png')}}" alt="img" />
                      </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                  <div class="theme_common_box_two img_hover">
                    <div class="theme_two_box_img">
                      <a href="hotel-details.html">
                        <img src="{{asset('assets/img/tab-img/hotel8.png')}}" alt="img" />
                      </a>
          ...
          <div class="px-20 py-20 rounded-4 border-light">
            <div class="row y-gap-30 justify-between xl:justify-">
              <div class="col-xl-4 col-lg-6">
                <div class="row y-gap-10 items-center">
                  <div class="col-sm-auto">
                    <img class="size-40" src="{{asset('assets/img/flightIcons/1.png')}}" alt="image" />
                  </div>
                  <div class="col">
              ...
              <div class="col-xl-4 col-lg-6">
                <div class="row y-gap-10 items-center">
                  <div class="col-sm-auto">
                    <img class="size-40" src="{{asset('assets/img/flightIcons/2.png')}}" alt="image" />
                  </div>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="home_client_wrpper h-100">
                        ...
                        <div class="home-two-quote">
                            <img src="{{asset('assets/img/icon/quote.png')}}" alt="img">
                ...
                <div class="col-lg-5">
                    <div class="home_three_client_right">
                        <img src="{{asset('assets/img/test.jpg')}}" alt="img" style="border-radius: 12px">
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="faqs_area_top">
        <div class="row">
          ...
          <div class="col-lg-4 contact-ushm">
            <img src="{{asset('assets/img/Contact-us.gif')}}" alt="img" />
