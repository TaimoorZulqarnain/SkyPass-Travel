    ...
    <div class="dashboard__main">
      <div class="dashboard__content">
        ...
        @include('admin.partials.errors')       
            <form method="POST" action="{{ route('agents.store') }}" id="main_author_form">
            @csrf
                <div class="col-xl-12">
                    <div class="row x-gap-20 y-gap-20">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="mobile" id="mobile" :value="old('mobile')" required class="form-control">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" name="agent_company" id="agent_company" :value="old('agent_company')" required class="form-control">
